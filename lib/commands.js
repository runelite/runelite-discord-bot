  ...
  switch (command) {
    case 'help': {
      const helpEmbed = createEmbed()
        ...
        .addField('!phwhois <name>', 'Lookup the name of author of Plugin Hub plugin (using full internal name, see https://github.com/runelite/plugin-hub/tree/master/plugins)')
