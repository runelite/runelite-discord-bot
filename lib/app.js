...
import {
  ...
  ensureRoles, hasPermissions, withoutMentions
} from './security.js'
...
async function onMessageDelete (message) {
  ...
  await logs.send(withoutMentions(`:wastebasket: ${buildUserDetail(user)}'s message was deleted${extraMessage}.${messageDetail}`))
}
