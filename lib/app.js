...
client.on('message', message => {
  ...
  if (filteredResult) {
    ...
    sendDM(message.author, `Your message was filtered. **Reason:** ${filteredResult}. **Message:**\n${message.content}`)
      .then(() => logs.send(`**${message.author.username}#${message.author.discriminator}'s** message was filtered. **Reason:** ${filteredResult}. **Message:**\n${message.content}`))
