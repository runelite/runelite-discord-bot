...
client.on('message', message => {
  ...
  if (filteredResult) {
    ...
    let messageDetail = `message was filtered.\n**Reason:** ${filteredResult}.`
    ...
    sendDM(message.author, `Your ${messageDetail}`)
      .then(() => logs && logs.send(`**${message.author.username}#${message.author.discriminator}'s** ${messageDetail}`))
...
client.on('messageDelete', (message) => {
  ...
  logs.send(`:wastebasket: **${user.username}#${user.discriminator}'s** message was deleted.${messageDetail}`)
})
