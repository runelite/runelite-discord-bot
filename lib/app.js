...
import { proccessFilters, resetMessageCache, buildUserDetail, buildMessageDetail, isOurDeletion, pruneDeletedMessages } from './security.js'
...
client.on('messageUpdate', (oldMessage, newMessage) => {
  proccessFilters(newMessage, client, true)
})
...
client.on('guildBanAdd', async (guildBan) => {
  ...
  const reasonMessage = guildBan.reason
